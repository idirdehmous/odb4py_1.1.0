## odb4py_1.1.0  release 


## Description  
This is the version 1.1.0 of odb4py.<br />
...
==> It has been widely developed and tested on ECMWF Atos machine. <br />
   On ATOS    : <br />
   module load   gcc/14.2.0           <br />
   module load   python3/3.12.x       <br />
...
## installation :  
   ...
   ```  
        ...
        git clone  https://github.com/idirdehmous/odb4py_1.1.0 
        ...
        STEP 1 - FIRST, CREATE A BUILD DIRECORY TO INSTALL THE ODB LIBRARIES.
	       ...
	       ODB_HOME=/path/to/../../odb/install/dir
               ...
               cmake    -DCMAKE_INSTALL_PREFIX=${ODB_HOME}         /path/to/../../odb4py_1.1.0 
...
```
REMARK:  <br />
-By the end the ODB installation, a file called 'odb_install_dir' will be created by cmake in the directory 'odb4py_1.1.0'. The latter will be used by setup.py <br />
...
```
        STEP 2 - cd  /path/to/source/of/.../odb4py_1.1.0  
...
-The odb4py installation is tested as follow : 
```
import odb4py
print( odb4py.__file__)  Prints the  location of the installed module
```

## Epilogue 
-If everything went well,one can use the example scripts under 'odb4py_1.1.0/tests' and reading the ODB(s) samples included in 'odb4py_1.1.0/odb_samples'. <br />


===> REMARK :
It's recommanded to run dcagen and dcagen.x just before archiving your ODB(s). <br /> 
This will allows odb4py to don't create them on the fly( even any odb apps like odbsql ,odbdump.x etc). Having DCA in ODB directory  make fatching the data a bit faster.  <br />
