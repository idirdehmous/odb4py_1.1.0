...
.. note::
   ...
   For some consistency and optimality reasons with `C/Python API <https://docs.python.org/3/c-api/index.html>`_ the original C routines and/or headers have been modified and/or removed. 
